...
try:
    ...
    print("Please create a .env file with GOOGLE_API_KEY='YOUR_API_KEY' and try again.")
    exit()
...
# Use a model that's good for this kind of task, like gemini-1.5-flash
...
def main():
    ...
    while True:
        ...
        # --- UPDATED QUERY LOGIC ---
        # Retrieve the top 3 chunks with their metadata
        results = collection.query(
            query_embeddings=[query_embedding],
            n_results=3,
            include=['documents', 'metadatas'] # Explicitly ask for documents and metadatas
        )
        
        retrieved_docs = results['documents'][0]
        retrieved_metadatas = results['metadatas'][0]
        
        # --- NEW: CONSTRUCT CONTEXT WITH METADATA ---
        context_string = ""
